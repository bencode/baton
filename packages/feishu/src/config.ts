...
// Default prompt: just relays who said what. Set FEISHU_PROMPT_TEMPLATE to
// invoke a project Skill, e.g. "收到飞书消息(来自 {sender}):\n{text}\n\n请用 xxx 技能处理。"
const DEFAULT_PROMPT = '收到飞书消息(来自 {sender}):\n\n{text}'
