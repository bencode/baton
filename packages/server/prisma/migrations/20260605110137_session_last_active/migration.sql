...
INSERT INTO "new_Session" ("agentKind", "agentSessionId", "createdAt", "id", "mode", "name", "nameLocked", "projectId", "shareToken", "updatedAt", "workerId", "worktreePath") SELECT "agentKind", "agentSessionId", "createdAt", "id", "mode", "name", "nameLocked", "projectId", "shareToken", "updatedAt", "workerId", "worktreePath" FROM "Session";
DROP TABLE "Session";
