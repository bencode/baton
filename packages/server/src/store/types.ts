...
// once at registration. workerId is required (Session → Worker FK, onDelete
// Restrict). agentKind + agentSessionId pin the session to a specific local
// agent state file on the worker machine.
